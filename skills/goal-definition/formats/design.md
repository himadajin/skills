...
- `Related Files`: bullet points only. List complementary handoff files that own separate decision areas, or write `- None` when there are none. If `ui.md` exists or should be created, reference it here and keep UI-specific decisions out of `design.md`.
